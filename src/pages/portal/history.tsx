...
function SummaryCard({
  ...
  return (
    <Paper withBorder p="sm" style={{ overflow: "hidden" }}>
      <Stack gap={4}>
        <Group gap={6} wrap="nowrap">
          <Text c={color} style={{ flexShrink: 0 }}>
            {icon}
          </Text>
...
function TuitionHistoryCard({
  ...
  return (
    <Card withBorder py="sm" mb="sm" style={{ overflow: "hidden" }}>
      <Stack gap="xs">
        <Group justify="space-between" wrap="nowrap">
          ...
          <Box style={{ flexShrink: 0 }}>{getStatusBadge(tuition.status)}</Box>
        </Group>
        <Divider />
        <Group justify="space-between" wrap="nowrap">
          ...
          <Stack gap={0} align="flex-end" style={{ minWidth: 0 }}>
            ...
            <Text size="sm" fw={600} c="green" truncate>
              <NumberFormatter
