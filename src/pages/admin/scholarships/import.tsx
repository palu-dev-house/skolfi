...
const ImportScholarshipsPage: NextPageWithLayout =
  function ImportScholarshipsPage() {
        ...
        <Paper withBorder p="lg">
          <Stack gap="md">
            ...
            >
              ...
              <List size="sm">
                <List.Item>
                  Download the Excel template which includes reference sheets
                ...
                <List.Item>
                  Full scholarships (nominal &gt;= monthly fee) will
                  automatically mark unpaid tuitions as paid
                </List.Item>
                <List.Item>
...
ImportScholarshipsPage.getLayout = (page: ReactElement) => (
  <AdminLayout>{page}</AdminLayout>
);

export default ImportScholarshipsPage;
