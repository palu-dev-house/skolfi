...
const ImportDiscountsPage: NextPageWithLayout = function ImportDiscountsPage() {
...
ImportDiscountsPage.getLayout = (page: ReactElement) => (
  <AdminLayout>{page}</AdminLayout>
);

export default ImportDiscountsPage;
